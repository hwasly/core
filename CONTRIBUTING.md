...
* The current HWasly version where the bug first appeared
* The last HWasly version where the bug did not exist
...
https://hwasly.org/about/road-map/

Feature requests beyond the scope of HWasly may still be provided
using the plugin framework:

https://github.com/hwasly/plugins/issues
